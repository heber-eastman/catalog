describe('Section 10 - Feature UIs & E2E Tests', () => {
  ...
  describe('Staff Management Enhanced', () => {
    ...
    it('should handle edit staff functionality', () => {
      ...
      cy.get('[data-cy="edit-staff-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
    ...
    it('should handle deactivate staff confirmation', () => {
      cy.get('[data-cy="deactivate-staff-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
  ...
  describe('Courses Management Enhanced', () => {
    ...
    it('should handle edit course functionality', () => {
      cy.get('[data-cy="edit-course-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
    ...
    it('should handle status change confirmation', () => {
      cy.get('[data-cy="toggle-status-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
  ...
  describe('Super Admins Management Enhanced', () => {
    ...
    it('should handle super admin actions', () => {
      ...
      cy.get('[data-cy="edit-super-admin-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
      ...
      cy.get('[data-cy="resend-invitation-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });

      // Test revoke invitation
      cy.get('[data-cy="revoke-invitation-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });

      // Test deactivate
      cy.get('[data-cy="deactivate-super-admin-btn"]', { timeout: 10000 })
        .first()
        .click({ force: true });
  ...
  describe('Accessibility Tests', () => {
    it('should have proper ARIA labels and roles', () => {
      ...
      cy.dataCy('add-customer-btn')
        .should('have.attr', 'aria-label')
        .or('contain.text', 'Add Customer');
    });
