...
export const notesAPI = {
  ...
  create: (customerId, data) => api.post(`/customers/${customerId}/notes`, data),
  update: (customerId, noteId, data) => api.put(`/customers/${customerId}/notes/${noteId}`, data),
  delete: (customerId, noteId) => api.delete(`/customers/${customerId}/notes/${noteId}`),
};
...
export const superAdminAPI = {
  ...
  updateCourseStatus: (id, status) => api.patch(`/super-admin/courses/${id}/status`, { status }),
  ...
  registerSuperAdmin: (data) => api.post('/super-admin/super-admins/register', data),
  ...
  resendInvite: (data) => api.post('/super-admin/super-admins/resend-invite', data),
  revokeInvite: (data) => api.post('/super-admin/super-admins/revoke-invite', data),
};
